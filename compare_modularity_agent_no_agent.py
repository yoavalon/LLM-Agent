...
columns = ['t1_ged', 't2_ged', 't3_ged', 't4_ged']
...
fig.suptitle('Comparison of Jaccard Metrics with Std Deviation', fontsize=16)
...
ax.set_title('Average Jaccard Metrics Comparison')
